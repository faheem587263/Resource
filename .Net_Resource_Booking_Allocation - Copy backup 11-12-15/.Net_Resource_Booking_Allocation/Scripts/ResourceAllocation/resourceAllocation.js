...
//    $("#fromweek option[value='24']").attr("selected", "selected");
    ...
    $('#btnsubmit').on('click', function () {
        ...
        $.ajax({
            url: 'ResourceAllocations.aspx/insertresourcedata',
            type: "GET",
            dataType: "json",
...
function GetResourceData(currentrow, arraynumber, skillVal, glbgrdVal, indgrdVal, fteFieldVal) {
    ...
    $.ajax({
        url: 'ResourceAllocations.aspx/getresourcedata',
        type: "GET",
        dataType: "json",
...
$('#ContentPlaceHolder1_drpprojectiD').change(function () {
...
$('#itss').on('click', function () {


    var dropvalue = $('#ContentPlaceHolder1_drpprojectiD option:selected').val();
    var fromweek = $('#fromweek option:selected').val();
    var toweek = $('#toweek option:selected').val()
    var strmaintable = "";
    for (var a = fromweek; a <= toweek; a++) {
    ...
    $("#Table2 > tbody  > tr .a, .skill, .glbgrd, .indgrd").focusout(function () {
        ...
        var fteFieldVal = $(this).closest('tr').find('input.fte').val();
        var arraynumber = $(this).closest('tr').find('td.sno').text();
        GetResourceDatadrop($(this).closest('tr'), dropvalue);
...
function GetResourceDatadrop(dropvalue) {

    var a = {};
    var b = $('#fromweek option:selected').val();
    $.ajax({
        url: 'ResourceAllocations.aspx/getresourcedatadrop',
        type: "GET",
        dataType: "json",
        data: { "ProjectId": $('#ContentPlaceHolder1_drpprojectiD option:selected').value()},
