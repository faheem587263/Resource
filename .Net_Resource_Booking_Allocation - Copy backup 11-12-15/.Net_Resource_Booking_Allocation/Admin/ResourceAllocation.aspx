		...
		<div class="three_quarter1 col ">
			<div class="block clear blogBlock">
				 ...
				 <div class="filters">
							...
							<div style="float:left"><label> Project Id :<span id="projectid"><asp:DropDownList 
                                    ID="drpprojectiD" runat="server" AutoPostBack="True" 
                                    onselectedindexchanged="drpprojectiD_SelectedIndexChanged"></asp:DropDownList></span></label>
