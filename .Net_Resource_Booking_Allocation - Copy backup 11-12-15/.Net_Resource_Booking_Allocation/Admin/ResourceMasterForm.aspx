<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminResourceAllocation.Master"
    AutoEventWireup="true" CodeBehind="ResourceMasterForm.aspx.cs" Inherits="Net_Resource_Booking_Allocation.Admin.ResourceForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <table class="tableValidation" style="margin: 12px,12px,12px,12px" >
            <tr>
                <td>
                    <asp:Label ID="lblResourceId" runat="server" Text="Resource Id"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblName" runat="server" Text="Resource Name"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpIncomanpyName"  runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpConName" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpSkillName" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DrpResYrId" runat="server">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
