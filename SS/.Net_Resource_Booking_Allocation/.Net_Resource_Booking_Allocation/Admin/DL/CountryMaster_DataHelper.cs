...
namespace Net_Resource_Booking_Allocation.Admin.DL
{
    public class CountryMaster_DataHelper 
    {
        ...
        internal void AddCountry(string Flag, string Prj_Country_Name, int Prj_Country_Active, int Prj_Country_Delete, string Prj_Insert_User_ID, string Prj_Update_User_ID, string Prj_Country_Yr_ID)
        {
            con = new SqlConnection(strConnString);
            cmd.CommandType = CommandType.StoredProcedure;
